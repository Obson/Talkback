...
if ( $show == 0 ) {
    ...
    switch ( $qtype ) {
        ...
        case 'thank_you':
            ...
            // IMPORTANT Some servers will require the From address to correspond
            // to an actual mailbox. For this reason the tutorial should advise
            // the user to set up a maibox for obson@<server-name>.
